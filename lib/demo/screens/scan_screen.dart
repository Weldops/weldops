...
class _ScanScreenState extends ConsumerState<ScanScreen> {
  ...
  void onConnectPressed(BluetoothDevice device) {
    device.connectAndUpdateStream().then(
      (value) async {
        // BluetoothBondState? bondState;
        // await device.bondState.first.then((state) {
        //   bondState = state;
        // });
        // if (bondState != BluetoothBondState.bonded) {
        //   const MethodChannel _platform =
        //       MethodChannel('com.example.bluetooth/pairing');
        //   await _platform
        //       .invokeMethod('pairDevice', {"address": device.remoteId.str});
        // }
        Future.delayed(
          Duration(seconds: 2),
          () async {
