...
//
// class AdfService extends ConsumerStatefulWidget {
//   const AdfService({super.key, required this.device});
//
//   final Map<String, dynamic> device;
//
//   @override
//   ConsumerState<AdfService> createState() => _AdfServiceState();
// }
//
// class _AdfServiceState extends ConsumerState<AdfService> {
...
//   }
//
//   List<LensRecord> lenseList = [];
//   bool isLoading = true;
//
//   @override
//   void didChangeDependencies() {
//     super.didChangeDependencies();
//     _loadLensRecords(); // Ensures data is refreshed when screen reappears
//   }
//
//   Future<void> _loadLensRecords() async {
//     try {
//       print("Starting to load lens records");
//       setState(() => isLoading = true);
//
//       final records = await DbService.instance.getAllRecords();
...
//     print("Building AdfService widget, isLoading: $isLoading");
...
//               ),
//             ),
//             ...lenseList.map((record) {
//               print("Building card for lens: ${record.title}");
//               return LensCard(
//                 id: record.id,
//                 hours: record.hours,
